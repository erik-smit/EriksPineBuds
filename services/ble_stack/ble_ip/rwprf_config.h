...
/// OpenPineBuds Config Service Server Role
#if defined(CFG_PRF_OPB_CONFIG)
#define BLE_OPB_CONFIG_SERVER   1
#else
#define BLE_OPB_CONFIG_SERVER   0
#endif // defined(CFG_PRF_OPB_CONFIG)

/// OpenPineBuds EQ Service Server Role
#if defined(CFG_PRF_OPB_EQ)
#define BLE_OPB_EQ_SERVER   1
#else
#define BLE_OPB_EQ_SERVER   0
#endif // defined(CFG_PRF_OPB_EQ)
...
/// BLE_CLIENT_PRF indicates if at least one client profile is present
        ...
        || BLE_UDS_CLIENT || BLE_BCS_CLIENT || BLE_VOICEPATH || BLE_DATAPATH_SERVER || BLE_OPB_CONFIG_SERVER || BLE_OPB_EQ_SERVER || BLE_ANC_CLIENT || BLE_BMS || BLE_OTA||BLE_AI_VOICE || BLE_TOTA || BLE_TILE)
